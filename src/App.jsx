...
import { ActionExample1 } from "./components/useFormStatusExample/PostsUseState";
import { ActionExample2 } from "./components/useFormStateExample/ShoppingCart";
  ...
  const router = createBrowserRouter(
    createRoutesFromElements(
      <Route path="/" element={<MainLayout />}>
        ...
        <Route path="useformstatus-example" element={<UseFormStatusExample />} />
        <Route
        ...
        />
        <Route path="useoptimistic-example" element={<UseOptimisticExample />} />
        <Route path="usetransition-example" element={<UseTransitionExample />} />
      </Route>
    )
  );
